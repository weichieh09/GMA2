...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).tel(DEFAULT_TEL).addr(DEFAULT_ADDR).email(DEFAULT_EMAIL);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).tel(UPDATED_TEL).addr(UPDATED_ADDR).email(UPDATED_EMAIL);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getAddr()).isEqualTo(DEFAULT_ADDR);
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).tel(UPDATED_TEL).addr(UPDATED_ADDR).email(UPDATED_EMAIL);
        ...
        assertThat(testCompany.getAddr()).isEqualTo(UPDATED_ADDR);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).tel(UPDATED_TEL).addr(UPDATED_ADDR).email(UPDATED_EMAIL);

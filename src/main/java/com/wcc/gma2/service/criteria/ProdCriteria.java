...
public class ProdCriteria implements Serializable, Criteria {
    ...
    public ProdCriteria(ProdCriteria other) {
        ...
        this.prodFeeId = other.prodFeeId == null ? null : other.prodFeeId.copy();
    ...
    public LongFilter getProdFeeId() {
        return prodFeeId;
    }

    public LongFilter prodFeeId() {
        if (prodFeeId == null) {
            prodFeeId = new LongFilter();
        }
        return prodFeeId;
    }

    public void setProdFeeId(LongFilter prodFeeId) {
        this.prodFeeId = prodFeeId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(prodFeeId, that.prodFeeId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, prodNo, enName, chName, hsCode, cccCode, prodFeeId, countryId, stdId, markId, cerfId, distinct);
    }
    ...
    public String toString() {
        return "ProdCriteria{" +
            ...
            (prodFeeId != null ? "prodFeeId=" + prodFeeId + ", " : "") +

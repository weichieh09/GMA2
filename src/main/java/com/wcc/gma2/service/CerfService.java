...
public class CerfService {
    ...
    /**
     * Get all the cerfs with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<CerfDTO> findAllWithEagerRelationships(Pageable pageable) {
        return cerfRepository.findAllWithEagerRelationships(pageable).map(cerfMapper::toDto);
    }
    ...
    public Optional<CerfDTO> findOne(Long id) {
        ...
        return cerfRepository.findOneWithEagerRelationships(id).map(cerfMapper::toDto);
    }

...
public class ProdService {
    ...
    /**
     * Get all the prods with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<ProdDTO> findAllWithEagerRelationships(Pageable pageable) {
        return prodRepository.findAllWithEagerRelationships(pageable).map(prodMapper::toDto);
    }
    ...
    public Optional<ProdDTO> findOne(Long id) {
        ...
        return prodRepository.findOneWithEagerRelationships(id).map(prodMapper::toDto);
    }

...
public class CerfCompany implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqCerfCompany")
    @SequenceGenerator(name = "seqCerfCompany")
    @Column(name = "id")
    private Long id;
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "cerfCompanies" }, allowSetters = true)

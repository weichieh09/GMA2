...
public class Prod implements Serializable {
    ...
    private Set<ProdFee> prodFees = new HashSet<>();
    ...
    public Set<ProdFee> getProdFees() {
        return this.prodFees;
    }

    public void setProdFees(Set<ProdFee> prodFees) {
        if (this.prodFees != null) {
            this.prodFees.forEach(i -> i.setProd(null));
        }
        if (prodFees != null) {
            prodFees.forEach(i -> i.setProd(this));
        }
        this.prodFees = prodFees;
    }

    public Prod prodFees(Set<ProdFee> prodFees) {
        this.setProdFees(prodFees);
        return this;
    }

    public Prod addProdFee(ProdFee prodFee) {
        this.prodFees.add(prodFee);
        prodFee.setProd(this);
        return this;
    }

    public Prod removeProdFee(ProdFee prodFee) {
        this.prodFees.remove(prodFee);
        prodFee.setProd(null);
        return this;
    }

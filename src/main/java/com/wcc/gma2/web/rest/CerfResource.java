...
public class CerfResource {
     ...
     */
    @PostMapping("/cerfs")
    public ResponseEntity<CerfDTO> createCerf(@RequestBody CerfDTO cerfDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/cerfs/{id}")
    public ResponseEntity<CerfDTO> updateCerf(@PathVariable(value = "id", required = false) final Long id, @RequestBody CerfDTO cerfDTO)

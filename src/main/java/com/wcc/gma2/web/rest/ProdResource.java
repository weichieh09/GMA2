...
public class ProdResource {
     ...
     */
    @PostMapping("/prods")
    public ResponseEntity<ProdDTO> createProd(@RequestBody ProdDTO prodDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/prods/{id}")
    public ResponseEntity<ProdDTO> updateProd(@PathVariable(value = "id", required = false) final Long id, @RequestBody ProdDTO prodDTO)

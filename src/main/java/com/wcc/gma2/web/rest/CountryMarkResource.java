...
import com.wcc.gma2.service.CountryMarkQueryService;
import com.wcc.gma2.service.CountryMarkService;
...
/**
 * REST controller for managing {@link com.wcc.gma2.domain.CountryMark}.
 */
@RestController
@RequestMapping("/api")
public class CountryMarkResource {
    ...
    public ResponseEntity<CountryMarkDTO> createCountryMark(@Valid @RequestBody CountryMarkDTO countryMarkDTO) throws URISyntaxException {
        ...
        CountryMarkDTO result = countryMarkService.save(countryMarkDTO);
        return ResponseEntity
            .created(new URI("/api/country-marks/" + result.getId()))
    ...
    public ResponseEntity<CountryMarkDTO> updateCountryMark(
        ...
        CountryMarkDTO result = countryMarkService.update(countryMarkDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/country-marks/{id}", consumes = { "application/json", "application/merge-patch+json" })
     ...
     */
    @GetMapping("/country-marks/count")
     ...
     */
    @GetMapping("/country-marks/{id}")
    public ResponseEntity<CountryMarkDTO> getCountryMark(@PathVariable Long id) {
     ...
     */
    @DeleteMapping("/country-marks/{id}")
    public ResponseEntity<Void> deleteCountryMark(@PathVariable Long id) {

    ...
    <b-row>
      <b-col cols="12">
        <b-form @submit="onSubmit" @reset="onReset" v-if="show">
          <b-row>
            <b-col cols="12">
              <b-form-group id="input-group-2" label="申請人名稱" label-for="input-2">
                <b-form-input id="input-2" v-model="form.companyChName" type="text" placeholder="申請人名稱"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
...
<script lang="ts" src="./wcc421.ts"></script>

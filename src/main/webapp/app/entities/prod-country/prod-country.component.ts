...
export default class ProdCountry extends Vue {
  ...
  public retrieveAllProdCountrys(): void {
  ...
  public prepareRemove(instance: IProdCountry): void {
  ...
  public removeProdCountry(): void {
    this.prodCountryService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('gma2App.prodCountry.deleted', { param: this.removeId });

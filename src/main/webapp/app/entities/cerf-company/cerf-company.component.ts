...
export default class CerfCompany extends Vue {
  ...
  public retrieveAllCerfCompanys(): void {
  ...
  public prepareRemove(instance: ICerfCompany): void {
  ...
  public removeCerfCompany(): void {
    this.cerfCompanyService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('gma2App.cerfCompany.deleted', { param: this.removeId });

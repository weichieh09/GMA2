...
export default class ProdSticker extends Vue {
  ...
  public retrieveAllProdStickers(): void {
  ...
  public prepareRemove(instance: IProdSticker): void {
  ...
  public removeProdSticker(): void {
    this.prodStickerService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('gma2App.prodSticker.deleted', { param: this.removeId });

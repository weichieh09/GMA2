...
export default class CountryStd extends Vue {
  ...
  public retrieveAllCountryStds(): void {
  ...
  public prepareRemove(instance: ICountryStd): void {
  ...
  public removeCountryStd(): void {
    this.countryStdService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('gma2App.countryStd.deleted', { param: this.removeId });

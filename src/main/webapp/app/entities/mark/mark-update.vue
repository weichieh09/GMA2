    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('gma2App.mark.cerf')" for="mark-cerf">Cerf</label>
            <select class="form-control" id="mark-cerf" data-cy="cerf" name="cerf" v-model="mark.cerf">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="mark.cerf && cerfOption.id === mark.cerf.id ? mark.cerf : cerfOption"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('gma2App.mark.sticker')" for="mark-sticker">Sticker</label>
            <select class="form-control" id="mark-sticker" data-cy="sticker" name="sticker" v-model="mark.sticker">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="mark.sticker && stickerOption.id === mark.sticker.id ? mark.sticker : stickerOption"

<template>
  <div>
      ...
      <table class="table table-striped" aria-describedby="countries">
          ...
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('countryNo')">
              ...
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse"
                :field-name="'countryNo'"></jhi-sort-indicator>
            </th>
        ...
        <tbody>
          <tr v-for="country in countries" :key="country.id" data-cy="entityTable">
            ...
            <td class="text-right">
              <div class="btn-group">
                <!-- <router-link :to="{ name: 'CountryView', params: { countryId: country.id } }" custom
                  v-slot="{ navigate }">
                ...
                <router-link :to="{ name: 'CountryEdit', params: { countryId: country.id } }" custom
                  v-slot="{ navigate }">
                ...
                <b-button v-on:click="prepareRemove(country)" variant="danger" class="btn btn-sm"
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"><span id="gma2App.country.delete.question" data-cy="countryDeleteDialogHeading"
      ...
      <div slot="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="jhi-confirm-delete-country" data-cy="entityConfirmDeleteButton"
          v-text="$t('entity.action.delete')" v-on:click="removeCountry()">
          Delete
        </button>
      </div>
    </b-modal>

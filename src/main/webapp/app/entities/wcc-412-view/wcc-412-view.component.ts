...
export default class Wcc412View extends Vue {
  ...
  public wcc412Views: IWcc412View[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllWcc412Views();
  }
  ...
  public retrieveAllWcc412Views(): void {

...
export default class CountryCert extends Vue {
  ...
  public retrieveAllCountryCerts(): void {
  ...
  public prepareRemove(instance: ICountryCert): void {
  ...
  public removeCountryCert(): void {
    this.countryCertService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('gma2App.countryCert.deleted', { param: this.removeId });

...
export default class FeeProdCerfCompany extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllFeeProdCerfCompanys();
  }
  ...
  public retrieveAllFeeProdCerfCompanys(): void {
  ...
  public prepareRemove(instance: IFeeProdCerfCompany): void {
  ...
  public removeFeeProdCerfCompany(): void {
    this.feeProdCerfCompanyService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('gma2App.feeProdCerfCompany.deleted', { param: this.removeId });

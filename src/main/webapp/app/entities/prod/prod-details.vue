    ...
    <div class="col-8">
      <div v-if="prod">
        ...
        <dl class="row jh-entity-details">
          ...
          <dt>
            <span v-text="$t('gma2App.prod.mark')">Mark</span>
          </dt>
          <dd>
        ...
        <router-link v-if="prod.id" :to="{ name: 'ProdEdit', params: { prodId: prod.id } }" custom v-slot="{ navigate }">

      ...
      <form name="editForm" role="form">
        ...
        <div>
          <div class="form-group" v-if="prod.id">
            ...
            <input type="text" class="form-control" id="id" name="id" v-model="prod.id" disabled />
          </div>
          ...
          <div class="form-group">
            ...
            <div v-if="$v.prod.cccCode.$anyDirty && $v.prod.cccCode.$invalid">
              <small class="form-text text-danger" v-if="!$v.prod.cccCode.maxLength"
                v-text="$t('entity.validation.maxlength', { max: 20 })">
                This field cannot be longer than 20 characters.
              </small>
            </div>
                  ...
                  <div class="col-md-5">
                    <b-button-group vertical>
                      ...
                      <!-- <button type="button" class="btn btn-danger btn-xs pull-right"
                        v-on:click="removeProdSticker(index)">
...
<script lang="ts" src="./prod-details.component.ts"></script>

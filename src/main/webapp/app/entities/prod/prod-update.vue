    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('gma2App.prod.sticker')" for="prod-sticker">Sticker</label>
            <select class="form-control" id="prod-sticker" data-cy="sticker" name="sticker" v-model="prod.sticker">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="prod.sticker && stickerOption.id === prod.sticker.id ? prod.sticker : stickerOption"

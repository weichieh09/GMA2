...
export default class StickerMark extends Vue {
  ...
  public retrieveAllStickerMarks(): void {
  ...
  public prepareRemove(instance: IStickerMark): void {
  ...
  public removeStickerMark(): void {
    this.stickerMarkService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('gma2App.stickerMark.deleted', { param: this.removeId });
